...
DevTools are a collection of tools that allow one to examine, edit, and debug HTML, CSS, and JavaScript on Firefox 
and Chrome for both the desktop and on mobile. 
* Similar to Safari Inspector element 
* Allow you to inspect code
There is a “Developer Edition” of Firefox that contains all of the DevTools
...
## Key Resources
The information below is key to getting started with accessibility in DevTools.  In fall 2017, we worked with the 
...
## Course Pages
This section contains links to courses that are using DevTools. Look here for how DevTools accessibility is being 
